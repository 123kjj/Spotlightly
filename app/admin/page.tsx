    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-12">
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          ...
          <p className="text-purple-400 text-sm">Moderate entries and manage reports</p>
        </div>
      </div>
        ...
        <div className="space-y-4">
          {pending.length === 0 ? (
            <div className="glass rounded-3xl p-12 text-center">
              ...
              <p className="text-purple-400 text-sm">No pending submissions.</p>
            </div>
          ) : pending.map(entry => (
                  ...
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="flex items-center gap-2 flex-shrink-0">
                      <a href={entry.youtubeUrl} target="_blank" rel="noopener noreferrer"
                        className="p-2 rounded-xl glass text-purple-400 hover:text-purple-600 transition-colors" title="Watch video">
        ...
        <div className="space-y-4">
          {reviewed.length === 0 ? (
            <div className="glass rounded-3xl p-12 text-center">
              ...
              <p className="text-purple-400 text-sm">Approved and rejected entries will show up here.</p>
            </div>
          ) : reviewed.map(entry => (
            <div key={entry.id} className="glass rounded-3xl p-5">
              <div className="flex items-start gap-4">
        ...
        <div className="space-y-4">
          {reports.length === 0 ? (
            <div className="glass rounded-3xl p-12 text-center">
              ...
              <p className="text-purple-400 text-sm">Everything looks clean!</p>
            </div>
          ) : reports.map(report => (
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-purple-700">
                    Entry: <Link href={`/contest/${report.contestId}#entry-${report.entryId}`} className="hover:underline text-purple-500">
                      View Entry
                    </Link>
                  </p>
                  {report.details && <p className="text-sm text-purple-500 mt-1">"{report.details}"</p>}
